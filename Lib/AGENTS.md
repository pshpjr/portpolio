...
1. [docs/exec-plans/active/INDEX.md](./docs/exec-plans/active/INDEX.md)에서 관련 active plan 확인
2. 관련 plan이 없으면 새 exec-plan을 먼저 작성하고 INDEX.md에 등록
3. exec-plan을 사용자에게 검토받기 전에는 코드, 빌드 설정, 테스트를 수정하지 않는다
4. 변경 대상이 정말 공용 코드인지 확인
5. 서버 또는 언리얼 전용 의존성이 없는지 점검
6. 필요하면 `README.md`에 폴더 구조와 사용 위치를 함께 갱신
