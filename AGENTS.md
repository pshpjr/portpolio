...
- `dummyserver/` — 예정
- `Claude-Code-Game-Studios-main/` — Game Studio 원본 데이터 소스(병합 기준)

## 상위 문서 구성

- `docs/` — 앱 바깥의 상위 문서 카테고리
- 기획서와 공용 워크플로 문서는 `docs/` 아래에서 관리
...
- Game Studio agent/skill 데이터도 최종 반영 위치는 루트 `.claude/agents/`, `.claude/skills/`다.
