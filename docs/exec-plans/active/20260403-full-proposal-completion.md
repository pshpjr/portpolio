...
- [ ] 3. design-author → 기획서 문서 보강·완성 (확정 가능한 항목만)
- [ ] 4. main.md 하위 문서 지도 갱신
- [ ] 5. 완료 처리
...
- [ ] 반복 리뷰 스크립트로 최소 2회 이상 리뷰 라운드를 실행한다.
- [ ] proposal 핵심 문서에 v1 컷라인과 UI/카메라/HUD 규칙이 반영된다.
- [ ] `pending-decisions.md`에 남은 사용자 결정 항목이 정리된다.
- [ ] 문서 검증을 다시 통과한다.
